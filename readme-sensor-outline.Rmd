...
The code below will open your files and allow you to select the sensor data you want to process. The data will be stored in the environment as "sensor_data" unless changed.
...
```{r}
process_sensors_excel <- function(person_location) {
...
process_sensors_excel(person_location)
...
#######################################
process_sensors_r <- function(person_location) {
...
process_sensors_r(person_location)
```
