...
```{r}
process_sensors_excel_version <- function(folder_name, path_file) {
   person_location <- read_csv(path_file)
...
process_sensors_excel_version(data, "20190730_BC29_Stephanie.csv")
...
#######################################
process_sensors_r_version <- function(folder_name, path_file) {
...
process_sensors_r_version(folder_name, path_file)
```
